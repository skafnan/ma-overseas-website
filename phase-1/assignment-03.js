...
// Q21) let arr1 = [10, 20, 30]
// let arr2 = arr1
// arr1[0] = 100
// console.log(arr1)
// console.log(arr2)
// arr1: _[100,20,30]__________
// arr2: __[100, 20 ,30]_____________

// Q23. Create an array original with values [1, 2, 3]. Create a copy using the spread operator .... Modify the copy and verify the original is unchanged.
// let original = [1, 2, 3];
// let copy = [...original];
